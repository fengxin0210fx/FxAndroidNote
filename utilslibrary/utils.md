...
* ### 栏相关 -> [BarUtil.java][bar.java] -> [Demo][bar.demo]
```
...
* ### 日志相关 -> [LogUtils.java][log.java] -> [Demo][LogUtils.dTagemo]
```
getConfig                : 获取 log 配置
...
* ### Snackbar 相关 -> [SnackBarUtil.java][snackbar.java] -> [Demo][snackbar.demo]
```
...
[bar.java]: https://github.com/Blankj/AndroidUtilCode/blob/master/lib/utilcode/src/main/java/com/blankj/utilcode/util/BarUtil.java
...
[LogUtils.dTagemo]: https://github.com/Blankj/AndroidUtilCode/blob/master/feature/utilcode/pkg/src/main/java/com/blankj/utilcode/pkg/feature/log/LogActivity.kt
...
[snackbar.java]: https://github.com/Blankj/AndroidUtilCode/blob/master/lib/utilcode/src/main/java/com/blankj/utilcode/util/SnackBarUtil.java
